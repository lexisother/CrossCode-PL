...
// <https://github.com/CCDirectLink/crosscode-ru/blob/master/src/types/utils.d.ts>
type MaybePromise<T> = T | Promise<T>;
type NullablePartial<T> = { [P in keyof T]?: T[P] | null };

// <https://github.com/CCDirectLink/crosscode-ru/blob/5cab767ad7bc6ba75efd541ba6839f6801f04dce/src/types/Localize-me.d.ts>
